...
class CartPoleEnv_adv(gym.Env):
    ...
    def __init__(self):
        ...
        # self.masscart = 1
        # self.masscart = 1.2
        self.masscart = 1.4 # meta_training_test
    ...
    # def randomize(self):
    #     self.masscart = np.random.uniform(0.5, 2)
    #     self.masspole = np.random.uniform(0.01, 0.2)
    #     self.total_mass = (self.masspole + self.masscart)
    #
    # def get_parameter(self):
    #     return np.array([self.masspole, self.masscart])
    #
    #
    # def get_parameter_name(self):
    #     return ['Mass_of_Pole', 'Mass_of_Cart']
    #
    # def set_parameter(self, parameter):
    #     self.masspole = parameter[0]
    #     self.masscart = parameter[1]
    #     self.total_mass = (self.masspole + self.masscart)
    #     self.polemass_length = (self.masspole * self.length)
    #     return
    #
    # def get_list_of_params(self):
    #     masspole = np.linspace(0.05, 0.2, 3)
    #     masscart = np.linspace(0.5, 2, 3)
    #
    #     params = []
    #     for j in range(len(masspole)):
    #         for i in range(len(masscart)):
    #             params.append([masspole[j], masscart[i]])
    #
    #     return params

    def randomize(self):
        self.masspole = np.random.uniform(0.01, 0.2)
        self.length = np.random.uniform(0.1, 1.0)
        self.total_mass = (self.masspole + self.masscart)
        self.polemass_length = (self.masspole * self.length)
    ...
    def get_parameter_name(self):
        return ['Mass_of_Pole', 'Length_of_Pole']
    ...
    def get_list_of_params(self):
        masspole = np.linspace(0.05, 0.15, 3)
        length = np.linspace(0.25, 0.75, 3)

        params = []
        for j in range(len(masspole)):
            for i in range(len(length )):
                params.append([masspole[j], length[i]])
    ...
    def step(self, action, impulse=0, process_noise=np.zeros([5])):
        ...
        self.state = np.array([x, x_dot[0], theta, theta_dot[0]])
               ...
               or theta < -self.theta_threshold_radians*2 \
               or theta > self.theta_threshold_radians*2
        # done = abs(x) > self.x_threshold
