...
class three_tank_system(gym.Env):
    ...
    def __init__(self, ref = np.array([0.1763, 0.6731, 480.3165, 0.1965, 0.6536, 472.7863, 0.0651, 0.6703, 474.8877])):
        ...
        self.interested_dims = [0, 1, 3, 4, 6, 7]
        ...
        self.kw = np.array([0.005, 0.005, 0.01, 0.005, 0.005, 0.01, 0.005, 0.005, 0.01]) # noise deviation
        self.bw = np.array([0.05, 0.05, 5, 0.05, 0.05, 5, 0.05, 0.05, 5]) # noise bound
        ...
        self.action_low = 0.0 * self.us
        self.action_high = 2 * self.us
    ...
    ## k vary
    # def randomize(self):
    #     decay_ratio = np.random.uniform(0.8, 1.0)
    #     decay_ratio_1 = np.random.uniform(0.95, 1.05) * decay_ratio
    #     decay_ratio_2 = np.random.uniform(0.95, 1.05) * decay_ratio
    #     decay_ratio_1 = np.clip(decay_ratio_1, 0.8, 1.0)
    #     decay_ratio_2 = np.clip(decay_ratio_2, 0.8, 1.0)
    #     decay_ratio_1 = np.random.uniform(0.95, 1.0)
    #     decay_ratio_2 = np.random.uniform(0.95, 1.0)
    #
    #     self.k1 = 2.77e3 * self.s2hr * decay_ratio_1
    #     self.k2 = 2.6e3 * self.s2hr * decay_ratio_2
    #
    ...
    #     k1 = np.linspace(self.k1 * 0.95, self.k1, 3)
    #     k2 = np.linspace(self.k2 * 0.95, self.k2, 3)
    #     num = 3
    #     params = []
    #     for i in range(num):
    #         for j in range(num):
    #             params.append([k1[i], k2[j]])
    #     #
    #
    #     # num = 9
    #     # decay_ratio_list = np.linspace(0.6, 1.0, num)
    #     # # k1 = np.random.uniform(0.9, 1.1, num) * decay_ratio_list * self.k1
    #     # # k2 = np.random.uniform(0.9, 1.1, num) * decay_ratio_list * self.k2
    #     #
    #     # params = []
    #     # for i in range(num):
    #     #     params.append([k1[i], k2[i]])
    #
    #     return params
    ...
    # def randomize(self):
    #
    #     self.F10 = np.random.uniform(3.5, 6.5)
    #     self.F20 = np.random.uniform(3.5, 6.5)
    #
    # def get_parameter(self):
    #     return np.array([self.F10, self.F20])
    #
    # def get_parameter_name(self):
    #     return ['F10', 'F20']
    #
    # def set_parameter(self, parameter):
    #     self.F10 = parameter[0]
    #     self.F20 = parameter[1]
    #     return
    #
    # def get_list_of_params(self):
    #     num = 3
    #     k1 = np.linspace(4, 6, num)
    #     k2 = np.linspace(4, 6, num)
    #
    #     params = []
    #     for i in range(num):
    #         for j in range(num):
    ...
    def randomize(self):
        ...
        self.T10 = np.random.uniform(150, 450)
        self.T20 = np.random.uniform(150, 450)

    def get_parameter(self):
        return np.array([self.T10, self.T20])

    def get_parameter_name(self):
        return ['T10', 'T20']

    def set_parameter(self, parameter):
        self.T10 = parameter[0]
        self.T20 = parameter[1]
        return

    def get_list_of_params(self):
        num = 3
        k1 = np.linspace(200, 400, num)
        k2 = np.linspace(200, 400, num)
    ...
    def step(self, action, impulse = 0):
        ...
        cost = np.linalg.norm(self.state[self.interested_dims] - self.reference[self.interested_dims])
        done = False
